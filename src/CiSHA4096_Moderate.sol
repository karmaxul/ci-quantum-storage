...
/**
 * @title CiSHA4096 - Moderate Gas Variant (Final Push)
 * @notice 96 rounds, 16 states, maximum loop + mixing optimization
 *         Target: ~1.6M - 1.9M gas
 */
contract CiSHA4096_Moderate {
    uint256 constant ROUNDS = 96;
